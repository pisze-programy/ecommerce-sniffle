...
import { catalogToSnapshot, currentWindow } from "./snapshot.ts";
...
function catalog(): Catalog {
  return {
    ...
    products: [
      ...
      { id: "p2", title: "BLUZA", url: "https://forcer.pl/products/bluza", variants: [variant({ id: "v2", quantity: 0, available: false })] },
    ],
  };
}
