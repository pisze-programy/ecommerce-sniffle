...
export const EXCLUDED_STOCK_IDS: Readonly<Record<string, readonly number[]>> = {
  ...
  osmpower: [
    516, 517, 518, 521, 525, 526, 546, 712, 756, 784, 790, 823, 824, 860, 875, 987,
    1010, 1015, 1055, 1066, 1084, 1100, 1124, 1127, 1136, 1175, 1205, 1214, 1240,
    1269, 1275, 1301, 1314, 1338, 1344,
  ],
