...
import { bloozieModule, parseDataVariants } from "./bloozie.ts";
          ...
          products: [
            {
              ...
              variants: [
                { id: 47190374973788, title: "default", available: true, price: "29.00" },
              ],
            },
          ],
        });
        return { ok: true, status: 200, json: async () => JSON.parse(body), text: async () => body, arrayBuffer: async () => Buffer.from(body).buffer as ArrayBuffer };
      }
      const html =
        '<div data-variants="[{ &quot;id&quot;: &quot;47190374973788&quot;, &quot;available&quot;: &quot;true&quot;, &quot;inventory_quantity&quot;: &quot;-5630&quot; }]"></div>';
      return { ok: true, status: 200, json: async () => ({}), text: async () => html, arrayBuffer: async () => Buffer.from(html).buffer as ArrayBuffer };
    };
