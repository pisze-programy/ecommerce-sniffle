...
const RAW_CONFIGS: readonly ProviderConfig[] = [
  ...
  { id: "montiel", domain: "montiel.com", platform: "shopify", schedule: "0 7 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 2, durationSeconds: 1000, requiresProxy: false, endpoint: "https://montiel.com/products.json", enabled: true },
