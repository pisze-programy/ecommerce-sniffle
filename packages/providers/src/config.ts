...
const RAW_CONFIGS: readonly ProviderConfig[] = [
  ...
  { id: "magdabutrym", domain: "magdabutrym.com", platform: "shopify", schedule: "0 11 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 2, durationSeconds: 600, requiresProxy: false, endpoint: "https://www.magdabutrym.com/sitemap-category/all.xml", enabled: true },
