...
const RAW_CONFIGS: readonly ProviderConfig[] = [
  ...
  { id: "forcer", domain: "forcer.pl", platform: "shopify", schedule: "0 5 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, durationSeconds: 150, requiresProxy: false, endpoint: "https://forcer.pl/products.json", enabled: true },
  { id: "misbhv", domain: "misbhv.com", platform: "shopify", schedule: "15 5 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, durationSeconds: 1800, requiresProxy: false, endpoint: "https://misbhv.com/products.json", enabled: true },
  ...
  { id: "gymglamour", domain: "gymglamour.com", platform: "shopify", schedule: "0 1 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, durationSeconds: 3600, requiresProxy: false, endpoint: "https://gymglamour.com/products.json", enabled: true },
  { id: "montiel", domain: "montiel.com", platform: "shopify", schedule: "0 7 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, durationSeconds: 1000, requiresProxy: false, endpoint: "https://montiel.com/products.json", enabled: true },
  { id: "noo-ma", domain: "noo.ma", platform: "shopify", schedule: "0 8 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, durationSeconds: 1500, requiresProxy: false, endpoint: "https://noo.ma/products.json", enabled: true },
  { id: "magdabutrym", domain: "magdabutrym.com", platform: "shopify", schedule: "0 11 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, durationSeconds: 600, requiresProxy: false, endpoint: "https://www.magdabutrym.com/sitemap-category/all.xml", enabled: true },
  { id: "nago", domain: "nago.com", platform: "shopify", schedule: "0 12 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, durationSeconds: 700, requiresProxy: false, endpoint: "https://nago.com/products.json", enabled: true },
  ...
  { id: "sklepbazy", domain: "sklepbazy.pl", platform: "custom", schedule: "40 4 * * *", window: "both", mode: "vps-mutation", stockSource: "cart-probe", ratePerSecond: 1, durationSeconds: 300, requiresProxy: true, endpoint: "https://sklepbazy.pl/", enabled: false },
  { id: "ekipatonosi", domain: "ekipatonosi.pl", platform: "custom", schedule: "45 4 * * *", window: "both", mode: "vps-mutation", stockSource: "cart-probe", ratePerSecond: 1, durationSeconds: 300, requiresProxy: true, endpoint: "https://ekipatonosi.pl/", enabled: false },
