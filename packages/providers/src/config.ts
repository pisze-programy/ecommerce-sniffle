...
const RAW_CONFIGS: readonly ProviderConfig[] = [
  ...
  { id: "magdabutrym", domain: "magdabutrym.com", platform: "shopify", schedule: "0 11 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, requiresProxy: false, endpoint: "https://www.magdabutrym.com/sitemap-category/all.xml", enabled: true },
  { id: "nago", domain: "nago.com", platform: "shopify", schedule: "0 12 * * *", window: "both", mode: "vps-get", stockSource: "embedded-json", ratePerSecond: 1, requiresProxy: false, endpoint: "https://nago.com/products.json", enabled: true },
  { id: "godsavequeens", domain: "pl.godsavequeens.com", platform: "shopify", schedule: "15 3 * * *", window: "both", mode: "vps-mutation", stockSource: "cart-probe", ratePerSecond: 1, requiresProxy: true, endpoint: "https://pl.godsavequeens.com/products.json", enabled: true },
  { id: "theodderside", domain: "theodderside.com", platform: "shopify", schedule: "30 3 * * *", window: "both", mode: "vps-mutation", stockSource: "cart-probe", ratePerSecond: 1, requiresProxy: true, endpoint: "https://theodderside.com/products.json", enabled: true },
  ...
  { id: "phlov", domain: "www.phlov.com", platform: "prestashop", schedule: "0 12 * * *", window: "both", mode: "vps-mutation", stockSource: "cart-probe", ratePerSecond: 1, requiresProxy: true, endpoint: "https://www.phlov.com/", enabled: true },
  ...
  { id: "osmpower", domain: "osmpower.pl", platform: "shoper", schedule: "35 4 * * *", window: "both", mode: "vps-mutation", stockSource: "basket-reveal", ratePerSecond: 1, requiresProxy: true, endpoint: "https://osmpower.pl/webapi/front/pl_PL/products/PLN/list", enabled: true },
  { id: "sklepbazy", domain: "sklepbazy.pl", platform: "custom", schedule: "40 4 * * *", window: "both", mode: "vps-mutation", stockSource: "cart-probe", ratePerSecond: 1, requiresProxy: true, endpoint: "https://sklepbazy.pl/", enabled: false },
  { id: "ekipatonosi", domain: "ekipatonosi.pl", platform: "custom", schedule: "45 4 * * *", window: "both", mode: "vps-mutation", stockSource: "cart-probe", ratePerSecond: 1, requiresProxy: true, endpoint: "https://ekipatonosi.pl/", enabled: false },
  ...
  { id: "dobrerzeczy", domain: "dobrerzeczy.pl", platform: "custom", schedule: "0 6 * * *", window: "both", mode: "vps-get", stockSource: "html", ratePerSecond: 1, requiresProxy: true, endpoint: "https://dobrerzeczy.pl/", enabled: true },
