...
import { requireValue } from '../../../../../../packages/providers/src/helpers.ts';
import {
  parseGraphQLCatalog,
  parseStorefrontToken,
  parseVariantId,
} from '../../../../../../packages/providers/src/providers/shopify/implementations/storefront.ts';

const seembolsConfig = requireValue(
